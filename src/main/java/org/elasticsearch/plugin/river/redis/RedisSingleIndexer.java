 ...
 */
class RedisSingleIndexer implements RedisIndexer {

    private static final String[] POISON = new String[]{"jekkyl", "hyde"};
    private static Logger logger = LoggerFactory.getLogger(RedisSingleIndexer.class);
    ...
    public RedisSingleIndexer(Client client, String index, boolean json, String messageField) {
        this.client = client;
        this.index = index;
        this.json = json;
